...
```powershell
gcloud projects add-iam-policy-binding enterprise-rag-504910 \
    --member="user:ashwiniambastha@gmail.com" \
...
gcloud projects add-iam-policy-binding enterprise-rag-504910 \
    --member="serviceAccount:349912933660-compute@developer.gserviceaccount.com" \
    --role="roles/documentai.apiUser"

# Grant VPC access to the Cloud Run Service Agent
gcloud projects add-iam-policy-binding enterprise-rag-504910 \
    --member="serviceAccount:service-349912933660@serverless-robot-prod.iam.gserviceaccount.com" \
